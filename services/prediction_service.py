...
class PredictionService:
    ...
    async def create_prediction(
        self, image_url: str, doctor_info: Dict, patient_info: Dict = None
    ) -> str:
        """
        ...
        try:
            ...
            prediction_record = {
                ...
                "image_info": {"url": image_url, "upload_date": datetime.utcnow()},
                ...
                "prediction_result": {
                    ...
                    "probability_distribution": prediction_details[
    ...
    async def get_predictions_by_doctor(
        self, doctor_id: str, limit: int = 20, skip: int = 0
    ) -> List[Dict]:
        """
        ...
        try:
            cursor = (
                self.collection.find({"doctor_info.id": doctor_id})
